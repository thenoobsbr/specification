...
internal abstract class OrSpecification<TEntity> : BaseSpecification<TEntity>
{
    private readonly IOrSpecificationComparisonBehavior<TEntity> _comparisonBehavior;
    private readonly ISpecification<TEntity> _left;
    private readonly ISpecification<TEntity> _right;

    protected OrSpecification(IOrSpecificationComparisonBehavior<TEntity> comparisonBehavior, ISpecification<TEntity> left, ISpecification<TEntity> right)
    {
